...
import project.core.repository.RefreshTokenRepository;
...
public class AuthService {
    ...
    public TokenDto reissue(TokenRequestDto tokenRequestDto) {
        ...
        RefreshToken refreshToken = refreshTokenRepository.findByKeyr(authentication.getName())
                .orElseThrow(() -> new RuntimeException("로그아웃 된 사용자입니다."));

        // 4. Refresh Token 일치하는지 검사
        if (!refreshToken.getValuer().equals(tokenRequestDto.getRefreshToken())) {
